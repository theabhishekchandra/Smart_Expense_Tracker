...
// Full Material 3 type scale (previously only bodyLarge was overridden; everything else
// silently fell back to the default Compose scale, which read inconsistently against the
// custom color scheme).
